...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  const [screenSettings, setScreenSettings] = useState([
    ...
    { id: 'flight-tracking', name: 'Flight Tracking Gantt', icon: 'Calendar', category: 'operations', enabled: false, required: false },
    { id: 'disruption', name: 'Affected Flights', icon: 'AlertTriangle', category: 'operations', enabled: true, required: false },
    { id: 'recovery', name: 'Recovery Options', icon: 'Plane', category: 'operations', enabled: false, required: false },
    ...
    { id: 'prediction-dashboard', name: 'Prediction Dashboard', icon: 'Brain', category: 'prediction', enabled: false, required: false },
    ...
    { id: 'reports', name: 'Reports & Analytics', icon: 'BarChart3', category: 'analytics', enabled: false, required: false },
