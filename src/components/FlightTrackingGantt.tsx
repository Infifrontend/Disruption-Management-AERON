...
export function FlightTrackingGantt() {
  ...
  const aircraftFleet = [
    {
      ...
      flights: [
        ...
        {
          id: `${airlineConfig.code}216`,
          departure: { time: "18:15", airport: "BOM" },
          arrival: { time: "21:30", airport: "DXB" },
          duration: 4.25,
          passengers: 175,
          status: "delayed",
          delay: 45,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}001`,
          departure: { time: "10:15", airport: "DEL" },
          arrival: { time: "12:45", airport: "DXB" },
          duration: 3.5,
          passengers: 185,
          status: "on-time",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}147`,
          departure: { time: "21:30", airport: "DXB" },
          arrival: { time: "03:15+1", airport: "IST" },
          duration: 4.75,
          passengers: 189,
          status: "on-time",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}525`,
          departure: { time: "23:45", airport: "COK" },
          arrival: { time: "02:30+1", airport: "DXB" },
          duration: 3.75,
          passengers: 175,
          status: "boarding",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}413`,
          departure: { time: "06:00", airport: "CMB" },
          arrival: { time: "09:30", airport: "DXB" },
          duration: 4.5,
          passengers: 181,
          status: "departed",
          delay: 15,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}047`,
          departure: { time: "13:25", airport: "BCN" },
          arrival: { time: "20:15", airport: "DXB" },
          duration: 6.83,
          passengers: 189,
          status: "cancelled",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}125`,
          departure: { time: "02:45", airport: "DXB" },
          arrival: { time: "06:30", airport: "TBZ" },
          duration: 2.75,
          passengers: 165,
          status: "departed",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}126`,
          departure: { time: "12:15", airport: "TBZ" },
          arrival: { time: "15:45", airport: "DXB" },
          duration: 2.5,
          passengers: 179,
          status: "on-time",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}384`,
          departure: { time: "01:25", airport: "PRG" },
          arrival: { time: "07:45", airport: "DXB" },
          duration: 5.33,
          passengers: 182,
          status: "departed",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}123`,
          departure: { time: "14:30", airport: "DXB" },
          arrival: { time: "18:45", airport: "KHI" },
          duration: 2.25,
          passengers: 189,
          status: "on-time",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}124`,
          departure: { time: "21:15", airport: "KHI" },
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}149`,
          departure: { time: "09:40", airport: "SLL" },
          arrival: { time: "12:25", airport: "DXB" },
          duration: 1.75,
          passengers: 165,
          status: "on-time",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}412`,
          departure: { time: "22:50", airport: "DXB" },
          arrival: { time: "07:15+1", airport: "BEG" },
          duration: 5.42,
          passengers: 189,
          status: "on-time",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}235`,
          departure: { time: "16:20", airport: "BEG" },
          arrival: { time: "21:45", airport: "DXB" },
          duration: 4.42,
          passengers: 175,
          status: "on-time",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}073`,
          departure: { time: "11:30", airport: "SKP" },
          arrival: { time: "16:15", airport: "DXB" },
          duration: 3.75,
          passengers: 182,
          status: "on-time",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}927`,
          departure: { time: "06:15", airport: "AUH" },
          arrival: { time: "07:30", airport: "DXB" },
          duration: 1.25,
          passengers: 155,
          status: "on-time",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}565`,
          departure: { time: "15:45", airport: "DXB" },
          arrival: { time: "19:20", airport: "BOM" },
          duration: 4.58,
          passengers: 189,
          status: "on-time",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}566`,
          departure: { time: "21:10", airport: "BOM" },
          arrival: { time: "23:35", airport: "DXB" },
          duration: 3.42,
          passengers: 175,
          status: "on-time",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}185`,
          departure: { time: "14:50", airport: "IST" },
          arrival: { time: "20:25", airport: "DXB" },
          duration: 4.58,
          passengers: 179,
          status: "on-time",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}343`,
          departure: { time: "04:20", airport: "TBS" },
          arrival: { time: "07:25", airport: "DXB" },
          duration: 3.08,
          passengers: 182,
          status: "departed",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}505`,
          departure: { time: "10:15", airport: "DXB" },
          arrival: { time: "12:45", airport: "DOH" },
          duration: 1.5,
          passengers: 165,
          status: "on-time",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}506`,
          departure: { time: "16:30", airport: "DOH" },
          arrival: { time: "19:15", airport: "DXB" },
          duration: 1.75,
          passengers: 175,
          status: "delayed",
          delay: 25,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}085`,
          departure: { time: "13:40", airport: "KWI" },
          arrival: { time: "16:55", airport: "DXB" },
          duration: 2.25,
          passengers: 172,
          status: "on-time",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}261`,
          departure: { time: "07:30", airport: "DAM" },
          arrival: { time: "11:15", airport: "DXB" },
          duration: 2.75,
          passengers: 165,
          status: "on-time",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}053`,
          departure: { time: "15:25", airport: "BGW" },
          arrival: { time: "17:50", airport: "DXB" },
          duration: 1.42,
          passengers: 175,
          status: "on-time",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}385`,
          departure: { time: "00:30", airport: "EBL" },
          arrival: { time: "02:45", airport: "DXB" },
          duration: 2.25,
          passengers: 155,
          status: "departed",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}627`,
          departure: { time: "08:20", airport: "DXB" },
          arrival: { time: "13:15", airport: "DEL" },
          duration: 3.92,
          passengers: 189,
          status: "on-time",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}628`,
          departure: { time: "15:45", airport: "DEL" },
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}323`,
          departure: { time: "03:15", airport: "ALA" },
          arrival: { time: "06:50", airport: "DXB" },
          duration: 4.58,
          passengers: 165,
          status: "departed",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}771`,
          departure: { time: "22:35", airport: "DXB" },
          arrival: { time: "04:20+1", airport: "ALA" },
          duration: 4.75,
          passengers: 189,
          status: "on-time",
          delay: 0,
    ...
    },
    {
      ...
      flights: [
        {
          id: `${airlineConfig.code}507`,
          departure: { time: "05:40", airport: "CCJ" },
          arrival: { time: "07:55", airport: "DXB" },
          duration: 2.25,
          passengers: 175,
          status: "departed",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}131`,
          departure: { time: "16:20", airport: "DXB" },
          arrival: { time: "21:35", airport: "BOM" },
          duration: 4.25,
          passengers: 189,
          status: "on-time",
          delay: 0,
        ...
        {
          id: `${airlineConfig.code}132`,
          departure: { time: "23:15", airport: "BOM" },
          arrival: { time: "02:25+1", airport: "DXB" },
          duration: 4.17,
          passengers: 165,
          status: "on-time",
          delay: 0,
    ...
    if (timeRange === "24h") {
        ...
        slots.push({
          ...
          label:
            day === 0
              ...
              : `${hour.toString().padStart(2, "0")}:00+${day}d IST`,
      ...
      for (let i = 0; i < 28; i++) {
        ...
        slots.push({
          ...
          isCurrentHour:
            day === 0 &&
            Math.floor(currentTime.getHours() / 6) === Math.floor(hour / 6),
  ...
  const filteredAircraft = aircraftFleet.filter((aircraft) => {
    ...
    if (
      ...
      aircraft.type !== filters.aircraftType
    )
      return false;
    ...
    if (
      ...
      !aircraft.type.toLowerCase().includes(filters.search.toLowerCase())
    )
      return false;
    ...
    if (
      filters.gate &&
      !aircraft.gate.toLowerCase().includes(filters.gate.toLowerCase())
    )
      return false;

    // Capacity range filter
    if (
      aircraft.capacity < filters.capacityRange[0] ||
      aircraft.capacity > filters.capacityRange[1]
    )
      return false;

    // Age range filter
    if (
      aircraft.age < filters.ageRange[0] ||
      aircraft.age > filters.ageRange[1]
    )
      return false;

    // Utilization range filter
    if (
      aircraft.utilization < filters.utilizationRange[0] ||
      aircraft.utilization > filters.utilizationRange[1]
    )
      return false;

    // Flight-specific filters
    if (filters.flightStatus !== "all") {
      const hasMatchingFlight = aircraft.flights.some(
        (flight) => flight.status === filters.flightStatus,
      );
      if (!hasMatchingFlight && aircraft.flights.length > 0) return false;
    }

    if (filters.delayThreshold[0] > 0) {
      const hasDelayedFlight = aircraft.flights.some(
        (flight) => flight.delay >= filters.delayThreshold[0],
      );
      if (!hasDelayedFlight && aircraft.flights.length > 0) return false;
    }

    if (filters.departureAirport !== "all") {
      const hasDepartureAirport = aircraft.flights.some(
        (flight) => flight.departure.airport === filters.departureAirport,
      );
      if (!hasDepartureAirport && aircraft.flights.length > 0) return false;
    }

    if (filters.arrivalAirport !== "all") {
      const hasArrivalAirport = aircraft.flights.some(
        (flight) => flight.arrival.airport === filters.arrivalAirport,
      );
      if (!hasArrivalAirport && aircraft.flights.length > 0) return false;
    }

    if (filters.priority !== "all") {
      const hasPriorityFlight = aircraft.flights.some(
        (flight) => flight.priority === filters.priority,
      );
  ...
  const getActiveFiltersCount = () => {
    ...
    if (filters.capacityRange[0] !== 150 || filters.capacityRange[1] !== 200)
      count++;
    ...
    <div className="space-y-6 h-full overflow-hidden">
      ...
      <div className="flex items-center justify-between flex-shrink-0">
        <div>
          <h2 className="text-2xl font-semibold">
            {airlineConfig.displayName} Flight Tracking Gantt
          </h2>
          <p className="text-muted-foreground">
            Aircraft schedules by tail number with real-time flight tracking
          </p>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-semibold">
                  {filteredAircraft.filter((a) => a.status === "active").length}
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-semibold">
                  {
                    filteredAircraft.filter((a) => a.status === "maintenance")
                      .length
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xl font-semibold">
                  {filteredAircraft.reduce(
                    (sum, a) =>
                      sum +
                      a.flights.filter((f) => f.status === "delayed").length,
                    0,
                  )}
                </p>
              </div>
                ...
                <div className="space-y-1 p-1">
                  {filteredAircraft.map((aircraft) => (
                    <div
                      ...
                      onClick={() =>
                        handleTailNumberSelection(aircraft.tailNumber)
                      }
                    >
                      ...
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <Badge
                          className={`text-xs px-1 py-0 ${getAircraftStatusColor(aircraft.status)}`}
                        >
                          {aircraft.status}
                        </Badge>
                      </div>
                    ...
                    {filteredAircraft.map((aircraft) => (
                      ...
                      >
                        ...
                        {aircraft.flights.map((flight, flightIndex) => {
                          const position = calculateFlightPosition(
      ...
      <Alert>
        ...
        <AlertDescription>
          <div className="flex items-center justify-between">
            <span>
              Last updated: {currentTime.toLocaleTimeString()} • Tracking{" "}
              {filteredAircraft.filter((a) => a.status === "active").length}{" "}
              active {airlineConfig.displayName} aircraft •
