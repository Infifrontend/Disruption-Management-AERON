                    ...
                    <CardContent>
                      {selectedOptionDetails?.rotation_plan?.aircraftOptions
                        ...
                        <div className="space-y-4">
                          ...
                          {/* Flight Rotation Impact Section */}
                          <Card className="mt-6">
                            <CardHeader>
                              <CardTitle className="text-sm flex items-center gap-2">
                                <Route className="h-4 w-4 text-flydubai-blue" />
                                Flight Rotation Impact
                              </CardTitle>
                            </CardHeader>
                            <CardContent>
                              {selectedOptionDetails?.rotation_plan?.aircraftOptions?.map(
                                (aircraft, aircraftIndex) => (
                                  aircraft.rotation_impact && Array.isArray(aircraft.rotation_impact) ? (
                                    <div key={aircraftIndex} className="mb-6">
                                      <h5 className="font-medium text-gray-800 mb-3">
                                        Aircraft {aircraft.reg || aircraft.aircraft} - Impact on Flights
                                      </h5>
                                      <Accordion type="multiple" className="w-full">
                                        {aircraft.rotation_impact.map((flightImpact, flightIndex) => (
                                          <AccordionItem key={`${aircraftIndex}-${flightIndex}`} value={`flight-${aircraftIndex}-${flightIndex}`}>
                                            <AccordionTrigger className="text-left">
                                              <div className="flex items-center gap-3 w-full">
                                                <div className="flex items-center gap-2">
                                                  <div className={`w-3 h-3 rounded-full ${
                                                    flightImpact.impact === "Low Impact" 
                                                      ? "bg-green-500" 
                                                      : flightImpact.impact === "Medium Impact"
                                                      ? "bg-yellow-500"
                                                      : "bg-red-500"
                                                  }`}></div>
                                                  <span className="font-medium">
                                                    {flightImpact.flightNumber}
                                                  </span>
                                                </div>
                                                <div className="flex items-center gap-4 text-sm text-gray-600">
                                                  <span>{flightImpact.origin_code} → {flightImpact.destination_code}</span>
                                                  <Badge className={`text-xs ${
                                                    flightImpact.status === "On Time" 
                                                      ? "bg-green-100 text-green-700"
                                                      : flightImpact.status === "Delayed"
                                              ...
                                              <div className="pt-4 pl-6 space-y-4">
                                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                                  <div>
                                                    ...
                                                    <p className="font-medium">{flightImpact.origin}</p>
                                                  </div>
                                                  <div>
                                                    <span className="text-gray-600">Destination:</span>
                                                    <p className="font-medium">{flightImpact.destination}</p>
                                                  </div>
                                                  <div>
                                                    <span className="text-gray-600">Departure:</span>
                                                    <p className="font-medium">
                                                      {new Date(flightImpact.departure).toLocaleString()}
                                                    </p>
                                                  </div>
                                                  <div>
                                                    <span className="text-gray-600">Arrival:</span>
                                                    <p className="font-medium">
                                                      {new Date(flightImpact.arrival).toLocaleString()}
                                                    </p>
                                                  </div>
                                                  <div>
                                                    <span className="text-gray-600">Delay:</span>
                                                    <p className={`font-medium ${
                                                      flightImpact.delay === "On Time" || flightImpact.delay === "0 min"
                                                        ? "text-green-600"
                                                        : "text-yellow-600"
                                                    }`}>
                                                      {flightImpact.delay}
                                                  ...
                                                  <div>
                                                    <span className="text-gray-600">Passengers:</span>
                                                    <p className="font-medium">{flightImpact.passengers}</p>
                                                  </div>
                                                  <div>
                                ...
                                <div className="text-center py-6 text-gray-500">
                                  ...
                                  <p>No rotation impact data available</p>
                                  <p className="text-xs mt-1">
                                    Impact analysis will be available once aircraft selection is confirmed
                                  </p>
                                </div>
                              )}
                            </CardContent>
