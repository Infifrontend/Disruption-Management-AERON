...
export function ComparisonMatrix({
  ...
  const [reassignedCrewData, setReassignedCrewData] = useState({}); // State to track reassigned crew

  // Function to track reassigned crew and their original details
  const updateReassignedCrew = (optionId, crewIndex, newCrew, originalCrew) => {
    setReassignedCrewData(prevState => ({
      ...prevState,
      [optionId]: {
        ...(prevState[optionId] || {}),
        [crewIndex]: {
          ...
          reason: "Crew reassignment tracked"
        }
      }
    }));
  };
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <TabsContent value="crew" className="space-y-4">
                  ...
                  {rotationPlanDetails?.reassignmentData?.hasReassignments && (
                        ...
                        <div className="grid grid-cols-3 gap-4 text-sm">
                          <div className="text-center">
                            <div className="text-2xl font-bold text-blue-600">
                              {rotationPlanDetails.reassignmentData.reassignmentSummary.totalCrewReassigned}
                            </div>
                            <div className="text-blue-600">Crew Reassigned</div>
                          </div>
                          <div className="text-center">
                            <div className="text-2xl font-bold text-blue-600">
                              {rotationPlanDetails.reassignmentData.reassignmentSummary.totalFlightChanges}
                            </div>
                            <div className="text-blue-600">Flight Changes</div>
                          </div>
                          <div className="text-center">
                            <div className="text-xs text-gray-600">Last Updated</div>
                            <div className="text-sm font-medium">
                              {rotationPlanDetails.reassignmentData.reassignmentSummary.lastUpdated ? 
                                new Date(rotationPlanDetails.reassignmentData.reassignmentSummary.lastUpdated).toLocaleTimeString() :
                                'N/A'
                              }
                            </div>
                          </div>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-sm flex items-center gap-2">
                        <Users className="h-4 w-4 text-flydubai-orange" />
                        Crew Availability Analysis
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      {rotationPlanDetails?.crew?.length > 0 ||
                      rotationPlanDetails?.crewData?.length >
                        0 ? (
                        <div className="space-y-6">
                                          ...
                                          <Button
                                            ...
                                            onClick={() => {
                                              setSelectedCrewForSwap({
                                                ...
                                                replacedCrew: crewMember.name, // Store original name for reassignment tracking
                                                previousStatus: crewMember.status, // Store original status
                                              });
                                              const availableCrew = generateAvailableCrewForRole(
                                                crewMember.role_code,
                                                crewMember.name,
                                              );
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="text-blue-700">
                      {selectedCrewForSwap.isEditing ? "New Assignment:" : "Original Crew:"}
                    </span>
                    <div className="font-medium">
                            ...
                            <Button
                              ...
                              onClick={() => {
                                ...
                                if (
                                  ...
                                  const originalIndex =
                                    selectedCrewForSwap.index;
                                  console.log(originalIndex);

                                  // Update the crew member with swap information
                                  updatedCrew[originalIndex] = {
                                    ...crew, // Use the new crew member's data
                                    isReassigned: true,
                                    reassignedFrom: selectedCrewForSwap.replacedCrew || selectedCrewForSwap.name, // Original crew member's name
                                    assignedAt: new Date().toISOString(),
                                    status: "Reassigned", // Update status to reflect reassignment
                                    availability: "On Duty", // Assuming reassigned means on duty
                                    isAutoAssigned: false, // Manual assignment overrides auto-assignment
                                    autoAssignedReplacement: undefined,
                                    originalAssignment: selectedCrewForSwap, // Store the original assignment details
                                  };
                                  console.log(
                                    updatedCrew[originalIndex],
                                    "Crew map ",
                                  ...
                                  updateReassignedCrew(
                                    selectedCrewForSwap.optionId,
                                    originalIndex,
                                    updatedCrew[originalIndex],
                                    selectedCrewForSwap
                                  );
                                ...
                                // assignmentUpdate logic seems redundant here, as state is updated above.
