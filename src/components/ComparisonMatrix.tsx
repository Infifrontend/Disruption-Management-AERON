...
// Helper function to get the current airline's currency code
// In a real application, this would likely come from context or a configuration store
const getCurrentAirlineCurrency = () => {
  // Placeholder: In a real app, fetch this dynamically based on airline context
  // For now, it defaults to AED as per the original code's context
  // You would integrate with your theme/airline configuration here.
  // Example:
  // const { airlineConfig } = useAppContext();
  // return airlineConfig?.currencyCode || 'AED';
  return "AED"; // Defaulting to AED as per original code
};
    ...
    options: [
      {
        ...
        cost: `${getCurrentAirlineCurrency()} 45,000`,
        timeline: "75 minutes",
        confidence: 95,
      ...
      },
      {
        ...
        cost: `${getCurrentAirlineCurrency()} 180,000`,
        timeline: "4-6 hours",
        confidence: 45,
      ...
      },
      {
        ...
        cost: `${getCurrentAirlineCurrency()} 520,000`,
        timeline: "Immediate",
        confidence: 75,
    ...
    options: [
      {
        ...
        cost: `${getCurrentAirlineCurrency()} 8,500`,
        timeline: "30 minutes",
        confidence: 92,
      ...
      },
      {
        ...
        cost: `${getCurrentAirlineCurrency()} 25,000`,
    ...
    options: [
      {
        ...
        cost: `${getCurrentAirlineCurrency()} 12,000`,
        timeline: "45 minutes",
        confidence: 88,
      ...
      },
      {
        ...
        cost: `${getCurrentAirlineCurrency()} 35,000`,
        timeline: "2-3 hours",
        confidence: 70,
      ...
      },
      {
        ...
        cost: `${getCurrentAirlineCurrency()} 85,000`,
    ...
    options: [
      {
        ...
        cost: `${getCurrentAirlineCurrency()} 15,000`,
        timeline: "60 minutes",
        confidence: 80,
      ...
      },
      {
        ...
        cost: `${getCurrentAirlineCurrency()} 95,000`,
        timeline: "Next day",
        confidence: 95,
    ...
    options: [
      {
        ...
        cost: `${getCurrentAirlineCurrency()} 18,000`,
        timeline: "90 minutes",
        confidence: 88,
      ...
      },
      {
        ...
        cost: `${getCurrentAirlineCurrency()} 8,000`,
        timeline: "30 minutes",
        confidence: 75,
      ...
      comparisonOptions.forEach((option, index) => {
        ...
        switch (metric.metric) {
          case "Total Cost":
            ...
            row[key] = `${getCurrentAirlineCurrency()} ${totalCost.toLocaleString()}`;
            break;
          case "OTP Score":
            row[key] =
                          ...
                          <div className="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                            <div className="flex items-start gap-2">
                              ...
                              <div className="text-sm text-blue-800">
                                <strong>Aircraft Selection Note:</strong> All
                                aircraft options below are feasible for this
                                route based on range, configuration, and
                                operational requirements. Select your preferred
                                aircraft by clicking the radio button in the
                                Actions column.
                              </div>
                            </div>
                          </div>
                ...
                {availableCrewForSwap.length > 0 ? (
                  <div className="space-y-3 max-h-96 overflow-y-auto">
                    {availableCrewForSwap.map((crew, index) => {
                      // Generate rotation impact data for this crew member
                      const rotationImpact = crew.rotation_impact || [
                        {
                          ...
                          origin: "Dubai",
                          reason:
                            "Standard crew rotation — no violations expected",
                          status: "On Time",
                          arrival: "2025-09-10T15:30:00+04:00",
                          departure: "2025-09-10T07:30:00+04:00",
                          passengers: 167,
                        ...
                        },
                        {
                          ...
                          reason:
                            "Brief crew handover — minimal delay expected",
                          status: "On Time",
                          arrival: "2025-09-10T20:45:00+04:00",
                          departure: "2025-09-10T16:15:00+01:00",
                          passengers: 189,
                          destination: "Dubai",
                          origin_code: "LHR",
                          flightNumber: "FZ002",
                      ...
                      return (
                        <React.Fragment key={index}>
                          <div className="relative p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                            ...
                            {/* Main Content Grid */}
                            <div className="grid grid-cols-5 gap-5 pr-20">
                              <div>
                                <h5 className="font-medium text-gray-900">
                                  {crew?.name}
                                </h5>
                              ...
                              <div>
                                <Button
                                  size="sm"
                                  className="bg-flydubai-orange hover:bg-flydubai-orange/90 text-white w-full"
                                  onClick={() => {
